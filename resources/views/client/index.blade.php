...
<section class="content-header">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
      <a href="{{url(route('clients.create'))}}" class="btn btn-primary"><i class="fa fa-plus"> New Client</i></a>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$record->name}}</td>
              <td class="text-center"><a href="{{url(route('clients.edit',$record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-edit">Edit</i></a>
              </td>
